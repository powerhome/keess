...
func TestKubeconfigLoader_StartWatching(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			timeToWait:     3,
			expectedLogs: []string{
				"Kubeconfig loader goroutine started",
				...
				"Kubeconfig loader goroutine stopped",
			},
		...
		},
		{
			...
			expectedLogs: []string{
				...
				"Kubeconfig loader rewatch goroutine started",
				...
				"Kubeconfig loader rewatch goroutine stopped",
				"Kubeconfig loader goroutine stopped",
			},
